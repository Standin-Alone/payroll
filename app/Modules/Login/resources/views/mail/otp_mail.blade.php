                                    ...
                                    <div style="background-color: #ffffff;width: 100% !important;">
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:arial,helvetica,sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:20px 10px 0px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">
                                    ...
                                    <div style="width: 100% !important;">
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:arial,helvetica,sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:6px 10px 20px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">
                                                                  ...
                                                                  <span style="font-size: 16px; line-height: 22.4px;">
                                                                    <strong>
                                                                      <span style="color: #595959; line-height: 22.4px; font-size: 16px;">
                                                                         <strong>{{$user_data['firstname']}} {{$user_data['lastname']}} {{$user_data['extname']}}</strong>
                                                                      </span>
                                                                    </strong>
                                                                  </span>
                                                                </p>
                                                    ...
                                                    <table width="500" border="0" cellpadding="0" cellspacing="0" style="min-width:500px">
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                          <td width="100%" height="50" style="line-height:1px;font-size:1px">
                                                            <div
                                                              style="font-family:sans-serif;color:#202020;text-align:center;font-size:26px;line-height:32px;line-height:100%;letter-spacing:2px">
                                                              {{$user_data['otp']}}
                                                            </div>
                                                          </td>
                                                        </tr>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">This is a
                                                                    system generated email and reply is not required.
                                                                </p>
                                                            </div>
